    ...
    const api_key = process.env.OAI_API_KEY;
        try {
            ...
            const prompt = `Here is data for analysis: \n${JSON.stringify(batchData)}
             Provide a detailed analysis and recommendation for mentors for the following batch data in the only JSON format as specified and not extra description:
             {
                "BatchData": {
                  "Name": "string",
                  "Module": "string",
